    ...
    <div className="bg-secondary text-white">
      <div className="container mx-auto pt-16 pb-6">
        <div className="flex md:justify-between justify-center text-center flex-wrap md:gap-y-0 gap-y-6 ">
          ...
          <div className="md:flex-1">
            <Title titleClass="text-[38px]">Feane</Title>
            <p className="mt-3">
          ...
          <div className="md:flex-1">
            <Title titleClass="text-[30px]">Opening Hours</Title>
            <div className="flex flex-col gap-y-2 mt-3">
              <div>
        ...
        <p className="text-center mt-10 hover:text-red-500">
          © 2022 All Rights Reserved By <a className="text-primary hover:text-red-500 " href="https://www.linkedin.com/in/ozturkersen/" target="_blank" rel="noopener noreferrer">ersenozturk</a>
        </p>
      </div>
    </div>
  );
