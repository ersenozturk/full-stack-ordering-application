...
const MenuItem = () => {
  return (
    <div className="bg-secondary text-white rounded-3xl">
      <div className="flex justify-center bg-[#F1F2F3] p-6 rounded-bl-[45px] rounded-tl-2xl rounded-tr-2xl">
        <div className="relative w-40 h-40 flex ">
          <Image src="/images/food.png" alt="" fill className="hover:scale-110 transition-transform delay-100" />
        </div>
      </div>
      <div className=" p-6">
